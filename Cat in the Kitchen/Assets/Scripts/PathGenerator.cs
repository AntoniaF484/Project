...
public class PathGenerator : MonoBehaviour
{
    ...
    public Transform
        generationPoint; //Point in the game at which paths and attached objects are generated (attached to camera position)
...
//Path 2 Variables
    ...
    void Start()
    {
        ...
        path1Position = new Vector3(transform.position.x, minYPath1, transform.position.z);
    ...
    public void GeneratePath1()
    {
       ...
       // distanceBetweenMinPath1 = 0;
     //   distanceBetweenMaxPath1 = 0;
        ...
        if (path1Position.x < generationPoint.position.x)
        {
            ...
            if (path1Position.x < generationPoint.position.x)
            {
               ...
               distanceBetweenPath1 = Random.Range(distanceBetweenMinPath1, distanceBetweenMaxPath1);
                ...
                Path1YChange =
                    path1Position.y + Random.Range(-maxYchangePath1, maxYchangePath1); // setting height of platform
                ...
                path1Position = new Vector3(
                    path1Position.x + (platformWidths1[platformSelector1] / 2) + distanceBetweenPath1,
    ...
    public void GeneratePath2()

        {
            ...
            if (path2Position.x < generationPoint.position.x)
            {
                ...
                Path2YChange =
                    path2Position.y + Random.Range(-maxYchangePath2, maxYchangePath2); //setting platform height
                ...
                path2Position = new Vector3(
                    path2Position.x + (platformWidths2[platformSelector2] / 2) + distanceBetweenPath2,
                ...
                {
                    objGenerator.SpawnFood(new Vector3(path2Position.x + Random.Range(
                            -(platformWidths2[platformSelector2] / 2),
                ...
                {
                    objGenerator.SpawnPowerUp(new Vector3(
                        path2Position.x + platformWidths2[platformSelector2] / 2 + distanceBetweenPath2 / 2,
                        path2Position.y + 6f,
                ...
                {
                    objGenerator.SpawnObstacle(new Vector3(path2Position.x + Random.Range(
                            -(platformWidths2[platformSelector2] / 2),
                            (platformWidths2[platformSelector2] / 2)), path2Position.y + 4f,
                        path2Position.z)); // generating obstacles on the platform just generated
                }
